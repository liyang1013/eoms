    ...
    <div>
        <el-form :inline="true" :model="rva" class="demo-form-inline" size="mini">
            ...
            <el-form-item label="收货单号:">
                <el-input v-model="rva.code_1" placeholder="收货单号"></el-input>
            </el-form-item>
            <el-form-item label="采购单号:">
                <el-input v-model="rva.code_2" placeholder="采购单号"></el-input>
            </el-form-item>
            <el-form-item label="供应商:">
                <el-input v-model="rva.pmc" placeholder="供应商编码/简称"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-alert title="采购收货: apmt110; JIT收货: apmt111; 委外收货: apmt200; 多角贸易采购收货: apmt300" type="success" class="tip_alert"
            :closable="false">
        </el-alert>
        ...
        <el-dialog :visible.sync="dialogTableVisible" width="1000px">
            ...
            <el-table :data="rvab.rvbList" border max-height="300px">
                ...
                <el-table-column prop="rvb07" label="数量" width="160">
                    <template slot-scope="scope">
                        <el-input-number v-model="scope.row.rvb07" controls-position="right" @change="scope.row.rvb88t = Math.round(scope.row.rvb07 * scope.row.rvb10t * 100)/100" :min="0"
                            :precision="2" :step="1" size="mini"></el-input-number>
                    </template>
                </el-table-column>
                <el-table-column prop="qty" label="WMS数量" width="120"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        resetrva(){
            ...
            this.$http.post('/api/rva/searchRvbList', { code_1: this.rvab.rva.rva01, centre: this.rvab.rva.rvaplant }).then(res => {
                this.rvab.rvbList = res.data.result
            })
        },
        alterRva(val){
